...
export default function GalleryPage() {
  ...
  const videos = [
    { id: "wuY7Hok3OSo", title: "Welcome to the OXYZ GMP Lab" },
    { id: "LduCUPy3C8M", title: "Heart Rate Variability (HRV)" }
  ];
                ...
                <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 z-10">
                  ...
                  <div className="flex flex-col sm:flex-row justify-center items-center gap-8 sm:gap-12">
                    ...
                    <div className="flex flex-col items-center gap-3">
                      ...
                      <div className="text-center">
                        <h4 className="text-sm font-semibold text-[#007A59]">Heart Rate Variability (HRV)</h4>
                        <p className="text-xs text-slate-600 mt-1">Track your health with HRV metrics</p>
                      </div>
                    </div>
                  </div>
                </div>
