        ...
        {pathname !== "/register" && (
          <Link href="/register">
            ...
            >
              ...
              <span className="text-white drop-shadow-sm">Register Now</span>
            </button>
          </Link>
        )}

        {/* WhatsApp Chat Button - Only shown on register page */}
        {pathname === "/register" && (
          <a 
          ...
          >
            ...
            <span className="text-white drop-shadow-sm">Ask Us</span>
          </a>
        )}
